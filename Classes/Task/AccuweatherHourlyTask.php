...
/**
 * Class AccuweatherHourlyTask
 */
class AccuweatherHourlyTask extends \TYPO3\CMS\Scheduler\Task\AbstractTask
{
    ...
    public function downloadWeatherFile()
    {
        ...
        $hourly_url     = $conf_settings['hourly_url'] ? $conf_settings['hourly_url'] : 'http://dataservice.accuweather.com/forecasts/v1/hourly/12hour/';
        $url            = $hourly_url.$placeid.'?apikey='.$appid.'&details=true&metric=true';
