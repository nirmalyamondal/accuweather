...
/**
 * Class AccuweatherCurrentTask
 */
class AccuweatherCurrentTask extends \TYPO3\CMS\Scheduler\Task\AbstractTask
{
    ...
    protected function cleanValues()
    {
        ...
        $this->log('$this->weather_placeid: '.$this->weather_placeid);
    }
    ...
    public function downloadWeatherFile()
    {
        ...
        $current_url    = $conf_settings['current_url'] ? $conf_settings['current_url'] : 'http://dataservice.accuweather.com/currentconditions/v1/';
        $url            = $current_url.$placeid.'?apikey='.$appid.'&details=true';
